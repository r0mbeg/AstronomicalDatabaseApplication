...
public class SatelliteAddController {
    ...
    void initialize() {
        ...
        AddButton.setOnAction(e ->{
            ...
            if (dH.objExist("planet", PlanetNameTextField.getText().trim()) == true &&
                    dH.objExist("satellite", addTextField.getText().trim()) == false) {
                dH.insertSatellite(addTextField.getText(),
